...
def search_eye_knowledge(topic: str) -> str:
    """
    Return eyecare knowledge for a given topic.
    Allowed topics: glaucoma, cataract, amd, dry eye, acute red eye
    """
...
def get_red_flag_rules() -> str:
    """
    Return red-flag eye symptoms requiring urgent or emergency evaluation.
    """
...
def get_patient_education(topic: str) -> str:
    """
    Return patient education text for a topic.
    """
